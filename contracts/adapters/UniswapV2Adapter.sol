...
/// @notice Adapter for Uniswap V2 and compatible DEXs
/// @dev Implements IDEXAdapter for Uniswap V2-style pools (constant product AMM)
/// @custom:pattern Adapter Pattern - Wraps Uniswap V2 functionality in standard interface
contract UniswapV2Adapter is IDEXAdapter {
    /// @notice Uniswap V2 factory address for pair lookups
    address public immutable factory;

    /// @notice Fee in basis points (30 = 0.3% for Uniswap V2)
    uint256 private constant FEE_BPS = 30;

    /// @notice Fee numerator (997 out of 1000 after 0.3% fee)
    uint256 private constant FEE_NUMERATOR = 997;

    /// @notice Fee denominator
    uint256 private constant FEE_DENOMINATOR = 1000;

    /// @notice Deploy UniswapV2Adapter with factory address
    /// @param factory_ Uniswap V2 factory address
